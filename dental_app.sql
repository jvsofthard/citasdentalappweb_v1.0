...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-03-2024 a las 04:42:24
...
INSERT INTO `odontologos` (`id`, `nombre`, `especialidad`) VALUES
(1, 'Carlos', 'Odontologia General'),
(2, 'Dr.jose', 'Odontologia General'),
(3, 'Dra. Maria Estel', 'Odontologia General');
...
CREATE TABLE `pacientes` (
  ...
  `apellido` varchar(100) NOT NULL,
  `odontologo_nombre` varchar(100) DEFAULT NULL,
